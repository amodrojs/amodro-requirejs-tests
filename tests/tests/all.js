...
// amodro no support: doh.registerUrl("isBrowser", "../isBrowser/isBrowser.html");
// amodro no support: doh.registerUrl("onResourceLoadNestedRequire", "../onResourceLoad/nestedRequire.html", 5000);
...
//JRB amodro in compat: doh.registerUrl("pluginShim", "../plugins/pluginShim/pluginShim.html");
...
// amodro disable, oustide ID space: doh.registerUrl("relativeOutsideBaseUrl", "../relative/outsideBaseUrl/a/outsideBaseUrl.html");
...
// amodro disabled, promise errbacks don't work that way: doh.registerUrl("undefLocal", "../undef/undefLocal.html", 8000);
...
// amodro disabled, callback/errbacks called differently now: doh.registerUrl("errorRequireErrback", "../error/requireErrback.html", 2000);
// amodro disabled, not error model wanted to support: doh.registerUrl("errorGlobalOnError", "../error/globalOnError.html", 2000);
